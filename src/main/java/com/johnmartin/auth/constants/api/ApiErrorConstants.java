...
public final class ApiErrorConstants {
    ...
    public static final String ENTER_A_VALID_EMAIL = "Enter a valid email";
    public static final String ENTER_A_VALID_PHONE_NUMBER = "Enter a valid phone number";
    ...
    public static final String FAILED_TO_FETCH_SOCIAL_USER = "Failed to fetch social user";
    ...
    public static final String USER_ACCOUNT_IS_NOT_YET_ACTIVATED = "User account is not yet activated";
